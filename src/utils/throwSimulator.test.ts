...
import { generateNormalDistribution } from './throwSimulator';
  ...
  describe('generateNormalDistribution', () => {
    ...
    describe('Box-Muller法の数学的性質', () => {
      ...
      test('mean を適用すると分布が平行移動する', () => {
        ...
        // Assert
        // 平均の差が mean の差にほぼ等しい
        expect(avg2 - avg1).toBeCloseTo(mean2 - mean1, 0);
      });
      ...
      test('stdDev を2倍にすると分布の広がりが2倍になる', () => {
        ...
        // Assert
        expect(calculatedStdDev2 / calculatedStdDev1).toBeCloseTo(2, 1);
      });
    });
