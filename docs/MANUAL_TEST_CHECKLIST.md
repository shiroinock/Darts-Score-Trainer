...
| 優先度 | 説明 | テストタイミング |
|--------|------|-----------------|
| **P0（必須）** | 基本機能が動作しないと致命的。リリース前に必ず確認 | 全リリース前 |
| **P1（高）** | 主要機能に影響。通常のリリースで確認 | メジャー/マイナーリリース |
| **P2（中）** | UX改善や補助機能。時間があれば確認 | 新機能追加時 |
| **P3（低）** | エッジケースや稀な操作。問題報告があれば確認 | 問題報告時 |

---

## 1. 基礎練習モード（1投・得点・独立） [P0]
